...
sys.path.insert(0, os.path.abspath('../../porise'))
sys.path.extend(
    [
...
project = "Porise"
copyright = "2021, Xiaolan Jiang, Just as an example website to show."
...
import porise  # isort:skip
version = str(porise.__version__)
