...
class BoltzmannExplorer(AlgoBase):
    """
    Boltzmann Explorer
    ...
    def train(self, action_list, arm_feat_list, reward_list):
        ...
        for reward, state_t in zip(reward_list, arm_feat_list):
            ...
            state_t = torch.tensor([state_t], dtype=torch.float).reshape(1,-1)
        ...
        for _ in range(int(train_count)):
            ...
            loss = self.criterion(reward_batch.reshape(-1), reward_pred.reshape(-1))
