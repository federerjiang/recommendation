import unittest
from porise.envs.synthetic.cosine_env import CosineEnv
...
class TestEnv(unittest.TestCase):
    ...
    def test_env_instantiation(self):
        env = CosineEnv(n_arm=3, feature_dim=10, max_steps=100, noise_std=0.1)
    ...
    def test_done(self):
        max_steps = 100
        env = CosineEnv(n_arm=3, feature_dim=10, max_steps=max_steps)
        while max_steps > 0:
