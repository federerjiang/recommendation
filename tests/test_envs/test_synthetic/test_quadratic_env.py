import unittest
from porise.envs.synthetic.quadratic_env import QuadraticEnv
...
class TestEnv(unittest.TestCase):
    ...
    def test_env_instantiation(self):
        env = QuadraticEnv(n_arm=3, feature_dim=10, max_steps=100)
    ...
    def test_done(self):
        max_steps = 100
        env = QuadraticEnv(n_arm=3, feature_dim=10, max_steps=max_steps)
        while max_steps > 0:
